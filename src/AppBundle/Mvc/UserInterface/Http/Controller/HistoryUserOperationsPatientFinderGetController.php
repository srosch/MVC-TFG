...
use Mvc\UserInterface\Http\Validator\HistoryUserOperationsPatientFindersGetValidator;
...
/** @Route("/mvc/history-operations/{patient}", methods={"GET"}) */
final class HistoryUserOperationsPatientFinderGetController extends BaseController
{
    public function __construct(
        QueryBus $queryBus,
        CommandBus $commandBus,
        HistoryUserOperationsPatientFindersGetValidator $validator
    ) {
    ...
    public function __invoke(Request $request): JsonResponse
    {
        ...
        $res = $this->ask(new HistoryUserOperationsPatientFindersQuery($userId, $id));
