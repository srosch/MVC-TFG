...
/** @Route("/mvc/history-allergy", methods={"GET"}) */
final class HistoryUserAllergyFindersGetController extends BaseController
{
    ...
    public function __invoke(Request $request): JsonResponse
    {
        ...
        $res = $this->ask(new HistoryUserAllergyFindersQuery($userId));
