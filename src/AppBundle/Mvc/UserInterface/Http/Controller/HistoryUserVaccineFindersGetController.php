...
/** @Route("/mvc/history-vaccine", methods={"GET"}) */
final class HistoryUserVaccineFindersGetController extends BaseController
{
    ...
    public function __invoke(Request $request): JsonResponse
    {
        ...
        $res = $this->ask(new HistoryUserVaccineFindersQuery($userId));
