...
/** @Route("/mvc/history-operations", methods={"GET"}) */
final class HistoryUserOperationsFindersGetController extends BaseController
{
    ...
    public function __invoke(Request $request): JsonResponse
    {
        ...
        $res = $this->ask(new HistoryUserOperationsFindersQuery($userId));
