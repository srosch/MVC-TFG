...
/** @Route("/mvc/history-disease", methods={"GET"}) */
final class HistoryUserDiseaseFindersGetController extends BaseController
{
    ...
    public function __invoke(Request $request): JsonResponse
    {
        ...
        $res = $this->ask(new HistoryUserDiseaseFindersQuery($userId));
