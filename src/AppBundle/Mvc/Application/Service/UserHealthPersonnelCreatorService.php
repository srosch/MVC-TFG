...
class UserHealthPersonnelCreatorService implements CommandHandler
{
    /** @var UserRepository */
    ...
    public function __invoke(UserHealthPersonnelCreatorCommand $command): void
    {
        ...
        $user = User::createHealthPersonnel(
            $command->id(),
            $command->name(),
            $command->password(),
    ...
    {
        return UserHealthPersonnelCreatorCommand::class;
    }

    /**
     * @param UserHealthPersonnelCreatorCommand $command
    */
