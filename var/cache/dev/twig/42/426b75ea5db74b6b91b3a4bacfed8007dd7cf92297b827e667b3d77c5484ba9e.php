...
class __TwigTemplate_386e369792f2f2b81c2457eed5efa27b273fd0ef76c9065bb13a2fa42a7f75fd extends \Twig\Template
{
    private $source;
    private $macros = [];
...
body {
    ...
    ";
        // line 29
        echo twig_get_attribute($this->env, $this->source, ($context["mixins"] ?? null), "sans_serif_font", [], "any", false, false, false, 29);
        echo "
    font-size: 14px;
    line-height: 1.4;
}
...
code, pre {
    ";
        // line 99
        echo twig_get_attribute($this->env, $this->source, ($context["mixins"] ?? null), "monospace_font", [], "any", false, false, false, 99);
        echo "
}
...
";
    ...
    ";
        // line 105
        echo twig_get_attribute($this->env, $this->source, ($context["mixins"] ?? null), "sans_serif_font", [], "any", false, false, false, 105);
        echo "
}
.btn {
    background: #777;
...
table {
    ";
        // line 150
        echo twig_get_attribute($this->env, $this->source, ($context["mixins"] ?? null), "subtle_border_and_shadow", [], "any", false, false, false, 150);
        echo ";
    margin: 1em 0;
    width: 100%;
}
...
table tbody td {
    ";
        // line 176
        echo twig_get_attribute($this->env, $this->source, ($context["mixins"] ?? null), "monospace_font", [], "any", false, false, false, 176);
        echo "
...
.break-long-words {
    ";
        // line 210
        echo twig_get_attribute($this->env, $this->source, ($context["mixins"] ?? null), "break_long_words", [], "any", false, false, false, 210);
        echo "
}
.text-small {
...
.font-normal {
    ";
        // line 228
        echo twig_get_attribute($this->env, $this->source, ($context["mixins"] ?? null), "sans_serif_font", [], "any", false, false, false, 228);
        echo "
    font-size: 14px;
}
.help {
...
.label.status-success { background: ";
        // line 256
        echo twig_get_attribute($this->env, $this->source, ($context["colors"] ?? null), "success", [], "any", false, false, false, 256);
        echo "; color: #FFF; }
.label.status-warning { background: ";
        // line 257
        echo twig_get_attribute($this->env, $this->source, ($context["colors"] ?? null), "warning", [], "any", false, false, false, 257);
        echo "; color: #FFF; }
.label.status-error   { background: ";
        // line 258
        echo twig_get_attribute($this->env, $this->source, ($context["colors"] ?? null), "error", [], "any", false, false, false, 258);
        echo "; color: #FFF; }
...
.metric {
    ";
        // line 272
        echo twig_get_attribute($this->env, $this->source, ($context["mixins"] ?? null), "subtle_border_and_shadow", [], "any", false, false, false, 272);
        echo ";
    min-width: 100px;
    min-height: 70px;
}
...
";
    ...
    ";
        // line 332
        echo twig_get_attribute($this->env, $this->source, ($context["mixins"] ?? null), "subtle_border_and_shadow", [], "any", false, false, false, 332);
        echo ";
    margin: 1em 0;
    padding: 10px;
}
...
.status-warning .colored {
    color: ";
        // line 372
        echo twig_get_attribute($this->env, $this->source, ($context["colors"] ?? null), "warning", [], "any", false, false, false, 372);
        echo ";
}
.status-error .colored  {
    color: ";
        // line 375
        echo twig_get_attribute($this->env, $this->source, ($context["colors"] ?? null), "error", [], "any", false, false, false, 375);
        echo ";
}
...
#summary .status-success { background: ";
        // line 518
        echo twig_get_attribute($this->env, $this->source, ($context["colors"] ?? null), "success", [], "any", false, false, false, 518);
        echo "; }
#summary .status-warning { background: ";
        // line 519
        echo twig_get_attribute($this->env, $this->source, ($context["colors"] ?? null), "warning", [], "any", false, false, false, 519);
        echo "; }
#summary .status-error   { background: ";
        // line 520
        echo twig_get_attribute($this->env, $this->source, ($context["colors"] ?? null), "error", [], "any", false, false, false, 520);
        echo ";   }
...
#menu-profiler .label-status-warning .count {
    background: ";
        // line 731
        echo twig_get_attribute($this->env, $this->source, ($context["colors"] ?? null), "warning", [], "any", false, false, false, 731);
        echo ";
}
#menu-profiler .label-status-error .count {
    background: ";
        // line 734
        echo twig_get_attribute($this->env, $this->source, ($context["colors"] ?? null), "error", [], "any", false, false, false, 734);
        echo ";
}
...
.tab-navigation li .badge.status-warning { background: ";
        // line 828
        echo twig_get_attribute($this->env, $this->source, ($context["colors"] ?? null), "warning", [], "any", false, false, false, 828);
        echo "; color: #FFF; }
.tab-navigation li .badge.status-error { background: ";
        // line 829
        echo twig_get_attribute($this->env, $this->source, ($context["colors"] ?? null), "error", [], "any", false, false, false, 829);
        echo "; color: #FFF; }
...
.queries-table pre {
    ";
        // line 883
        echo twig_get_attribute($this->env, $this->source, ($context["mixins"] ?? null), "break_long_words", [], "any", false, false, false, 883);
        echo "
    margin: 0;
    white-space: pre-wrap;
}
...
#collector-content .sf-dump samp {
    ";
        // line 922
        echo twig_get_attribute($this->env, $this->source, ($context["mixins"] ?? null), "monospace_font", [], "any", false, false, false, 922);
        echo "
}
...
";
    ...
    ";
        // line 981
        echo twig_get_attribute($this->env, $this->source, ($context["mixins"] ?? null), "sans_serif_font", [], "any", false, false, false, 981);
        echo "
    vertical-align: middle;
}
...
";
    ...
    {
        return array (  1102 => 995,  1087 => 981,  1084 => 980,  1025 => 922,  1017 => 916,  991 => 890,  983 => 883,  968 => 870,  961 => 863,  947 => 849,  933 => 835,  926 => 829,  922 => 828,  869 => 777,  831 => 739,  825 => 734,  819 => 731,  721 => 635,  685 => 599,  658 => 572,  643 => 557,  605 => 520,  601 => 519,  597 => 518,  578 => 501,  541 => 464,  500 => 423,  474 => 397,  457 => 380,  451 => 375,  445 => 372,  422 => 351,  402 => 332,  399 => 331,  395 => 327,  338 => 272,  326 => 262,  321 => 258,  317 => 257,  313 => 256,  282 => 228,  261 => 210,  240 => 191,  224 => 176,  195 => 150,  186 => 143,  147 => 105,  144 => 104,  138 => 99,  65 => 29,  54 => 20,  50 => 16,  47 => 12,  45 => 11,  42 => 9,  40 => 3,);
    }

    public function getSourceContext()
    {
        return new Source("", "WebProfilerBundle:Profiler:profiler.css.twig", "/var/www/mvc/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views/Profiler/profiler.css.twig");
    }
}
