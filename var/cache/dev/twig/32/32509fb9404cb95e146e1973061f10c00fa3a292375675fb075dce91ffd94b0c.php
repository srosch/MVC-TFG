...
class __TwigTemplate_4db5ff5f2a31fa8ba6ee27d2ff7df451dcf805adf30840461ab2ced4621c7885 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    public function block_toolbar($context, array $blocks = [])
    {
        ...
        // line 4
        echo "    ";
        if (((twig_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "violationsCount", [], "any", false, false, false, 4) > 0) || twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "calls", [], "any", false, false, false, 4)))) {
            // line 5
            echo "        ";
        ...
        ";
            ...
            <div class=\"sf-toolbar-info-piece\">
                ...
                <span class=\"sf-toolbar-status";
            // line 20
            echo (((twig_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "violationsCount", [], "any", false, false, false, 20) > 0)) ? (" sf-toolbar-status-red") : (""));
            echo "\">";
    ...
    public function block_menu($context, array $blocks = [])
    {
        ...
        ";
        // line 32
        if ((twig_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "violationsCount", [], "any", false, false, false, 32) > 0)) {
            // line 33
...
";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["call"]) {
            ...
            echo "\">
                <div class=\"trace\">
                    ";
            // line 62
            echo $this->extensions['Symfony\Bridge\Twig\Extension\CodeExtension']->fileExcerpt(twig_get_attribute($this->env, $this->source, ($context["caller"] ?? null), "file", [], "any", false, false, false, 62), twig_get_attribute($this->env, $this->source, ($context["caller"] ?? null), "line", [], "any", false, false, false, 62));
            echo "
                </div>
            </div>
    ...
    {
        return new Source("", "WebProfilerBundle:Collector:validator.html.twig", "/var/www/mvc/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views/Collector/validator.html.twig");
    }
}
