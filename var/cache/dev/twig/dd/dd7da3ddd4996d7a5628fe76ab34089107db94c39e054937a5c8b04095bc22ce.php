...
class __TwigTemplate_757271de052dbb3533799ee9785f5589a1db8ca78afff4284ef63d450b2280ce extends \Twig\Template
{
    private $source;
    private $macros = [];
        ...
        if (twig_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "enabled", [], "any", false, false, false, 91)) {
            ...
            if (twig_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "token", [], "any", false, false, false, 92)) {
                ...
                <div class=\"metric\">
                    <span class=\"value\">";
                // line 95
                (((twig_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "user", [], "any", false, false, false, 95) == "anon.")) ? (print ("Anonymous")) : (print (twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "user", [], "any", false, false, false, 95), "html", null, true))));
                echo "</span>
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            ";
                // line 116
                echo ((twig_test_empty(twig_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "roles", [], "any", false, false, false, 116))) ? ("none") : (call_user_func_array($this->env->getFunction('profiler_dump')->getCallable(), [$this->env, twig_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "roles", [], "any", false, false, false, 116), 1])));
                echo "
                ...
                if (twig_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "supportsRoleHierarchy", [], "any", false, false, false, 124)) {
                    ...
                    echo "                    <tr>
                        ...
                        <td>";
                    // line 127
                    echo ((twig_test_empty(twig_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "inheritedRoles", [], "any", false, false, false, 127))) ? ("none") : (call_user_func_array($this->env->getFunction('profiler_dump')->getCallable(), [$this->env, twig_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "inheritedRoles", [], "any", false, false, false, 127), 1])));
                    echo "</td>
                    </tr>
                    ";
                }
                ...
                if (twig_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "token", [], "any", false, false, false, 131)) {
                    ...
                    echo "                    <tr>
                        ...
                        <td>";
                    // line 134
                    echo call_user_func_array($this->env->getFunction('profiler_dump')->getCallable(), [$this->env, twig_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "token", [], "any", false, false, false, 134)]);
                    echo "</td>
                    </tr>
                    ";
                }
            ...
            ";
                ...
                <table>
                    ...
                    echo "</td>
                        ...
                        <tr>
                            ...
                            <td>";
                    // line 205
                    echo ((twig_test_empty(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "firewall", [], "any", false, false, false, 205), "listeners", [], "any", false, false, false, 205))) ? ("(none)") : (call_user_func_array($this->env->getFunction('profiler_dump')->getCallable(), [$this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "firewall", [], "any", false, false, false, 205), "listeners", [], "any", false, false, false, 205), 1])));
                    echo "</td>
                        </tr>
                    </tbody>
                </table>
                ...
                ";
                        ...
                        foreach ($context['_seq'] as $context["_key"] => $context["listener"]) {
                            // line 228
                            echo "                            ";
                            if ((twig_get_attribute($this->env, $this->source, $context["loop"], "first", [], "any", false, false, false, 228) || ($context["listener"] != ($context["previous_event"] ?? null)))) {
                                // line 229
                                echo "                                ";
...
($context["attribute"] ?? null), "type", [], "any", false, false, false, 323) == "string")) {
                        ...
                        // line 326
                        echo "                                     ";
                        echo call_user_func_array($this->env->getFunction('profiler_dump')->getCallable(), [$this->env, ($context["attribute"] ?? null)]);
                        echo "
                                ";
                    }
                    // line 328
