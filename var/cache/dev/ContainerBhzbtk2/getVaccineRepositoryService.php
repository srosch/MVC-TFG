...
// Returns the public 'Mvc\Domain\VaccineRepository' shared autowired service.
...
return $this->services['Mvc\\Domain\\VaccineRepository'] = new \Mvc\Infrastructure\Doctrine\DoctrineVaccineRepository($a, $a);
