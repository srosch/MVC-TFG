...
// Returns the public 'Mvc\Domain\UserRepository' shared autowired service.
...
return $this->services['Mvc\\Domain\\UserRepository'] = new \Mvc\Infrastructure\Doctrine\DoctrineUserRepository($a, $a);
